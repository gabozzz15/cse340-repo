 ...
 * Hashes the user's password with bcrypt before storing in the database.
 */
 ...
 * Verifies credentials and stores the user in the session on success.
 */
...
/**
 * Middleware factory that requires a specific role for route access.
 * Returns a middleware function that checks if the logged-in user has the required role.
 *
...
const showUsersPage = async (req, res) => {
    try {
        ...
        req.flash('error', 'An error occurred while loading the users page.');
        res.redirect('/dashboard');
    }
};
